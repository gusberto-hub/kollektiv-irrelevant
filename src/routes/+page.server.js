export async function load() {
	...
	const artistsData = await getStartPageArtists();

	return { events: eventsData.events, artists: artistsData.artists };
}
...
const getStartPageArtists = () =>
	fetch('https://api-eu-central-1-shared-euc1-02.hygraph.com/v2/clkwz4vam05q701uj61zjhqpf/master', {
		...
		body: JSON.stringify({
			query: `{artists(where: {onStartPage: true})
			{
			  name
			  artistImage {
				url
